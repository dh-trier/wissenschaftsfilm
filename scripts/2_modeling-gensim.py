...
corpusdir = join(workingdir, "data", "ann", "")
corpusfiles = [join(corpusdir, "wfilm.txt"), join(corpusdir, "nfilm.txt")]
stoplistfile = join(workingdir, "data", "names-plus.txt")
...
resultsfolder = join(workingdir, "gensim", str(timestamp)+"_film", "")
